...
public class MoocInitializer extends ChannelInitializer<SocketChannel> {

	boolean compress = false;
	MoocHandler handler;

	public MoocInitializer(MoocHandler handler, boolean enableCompression) {
		System.out.println("---------- inside MoocInitializer-------------------");
